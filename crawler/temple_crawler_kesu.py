...
if __name__ == "__main__":
    try:
        ...
        projectId = 238836  # 100799

        invest = 50000
        useCouponArr = '{\"10\": 0, \"30\": 0,\"50\": 0, \"100\": 0, \"300\": 0, \"500\": 1}'
        userPayPassword = 258611
        useIncreaseCouponArr = '{}'  # '{\"0.50\":1}'
        sid = 'cqhjbaglfjq3cpuokctguagrt9'
        cookie = 'kesucorp=cqhjbaglfjq3cpuokctguagrt9; UM_distinctid=1628ebd7a3d592-0fd970db1fd89a-476b0f37-100200-1628ebd7a3f43c; CNZZDATA1253692730=398072650-1522808289-https%253A%252F%252Fpassport.kesucorp.com%252F%7C1522808289'

        firetime = datetime.combine(
            datetime.now().today(), time(12, 59, 34, 200))
