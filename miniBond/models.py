...
class Platform(models.Model):
    ...
    def hasvalidLinktowx(self):
        return self.linktowx and self.linktowx.isValid

    def hasvalidPromotion(self):
        return self.promotioninfo_set.filter(isValid).count() > 0
...
class LinkToWx(models.Model):
    ...
    image = models.ImageField(
        upload_to="static/img/toWx", blank=True, null=True)
